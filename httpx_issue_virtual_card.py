...
open_debit_card_account_response = httpx.post(
    "http://127.0.0.1:8003/api/v1/accounts/open-debit-card-account",
...
issue_virtual_card_response = httpx.post(
    "http://127.0.0.1:8003/api/v1/cards/issue-virtual-card",
...
print('Issue virtual card response status code:',issue_virtual_card_response.status_code)
